...
function App() {
  ...
  if (usuarioLogado) {
    return <Restaurantes onLogout={() => setUsuarioLogado(false)} />;
  }
        ...
        * {
        ...
        @media (min-width: 1024px) {
          ...
          .login-banner { 
            ...
            padding: 3rem; 
            text-align: center; 
            box-shadow: 20px 0 40px -15px rgba(220, 38, 38, 0.3);
            position: relative;
            overflow: hidden;
          }
          ...
          <div className="form-wrapper">
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              ...
              <p style={{ margin: 0, color: '#64748b', fontSize: '1rem' }}>
                {isLogin ? 'Acesse o painel administrativo' : 'Crie sua conta para começar'}
              </p>
            </div>
